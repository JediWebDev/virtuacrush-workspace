...
const CATEGORY_GUIDE: Record<string, string> = {
  ...
  crime: 'illegal acts — theft, shoplift, armed_robbery, arson, assault, vandalism, kidnapping, fraud, reckless_endangerment. Setting off fireworks/explosives or starting a fire indoors IS a crime (arson if it ignites, otherwise reckless_endangerment). Public lewd/sexual acts, masturbating in public, flashing, or streaking are crimes -> indecent_exposure.',
