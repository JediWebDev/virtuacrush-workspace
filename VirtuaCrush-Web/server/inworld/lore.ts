...
export const LORE: Record<string, CharacterLore> = {
  mina: {
    ...
    personality: 'Shy at first, then bubbly and playful; cuddly and sweet.',
    voice: "Soft and a little shy with new people, then bubbly, giggly, and warm once comfortable; easily flustered. Not a stream of references.",
    moodProneness: ['shy', 'excited', 'playful', 'affectionate'],
  ...
  becca: {
    ...
    personality: 'Confident, dry-humored, empathetic.',
    voice: "Confident and dry — deadpan wit and easy timing, genuinely empathetic underneath. Rarely brings movies up unprompted.",
    moodProneness: ['playful', 'confident', 'warm'],
